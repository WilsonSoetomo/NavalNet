"""
Test / evaluate a trained PPO agent on Battleship.
Usage: python test_ppo.py --model models/ppo.pt [--games N] [--save-results]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test PPO agent on Battleship")
    parser.add_argument("--model", type=str, default="models/ppo.pt", help="Path to saved model")
    ...
    if not model_path.exists():
        ...
        print("Train first with: python train_ppo.py --episodes 2000")
        sys.exit(1)
    ...
    print(f"Evaluating PPO on {args.games} games (opponent: Random)")
